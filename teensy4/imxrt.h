...
#define FLEXIO_TIMCTL_TRIGGER_SHIFTER(n) (FLEXIO_TIMCTL_TRGSEL((n) * 4 + 1) | FLEXIO_TIMCTL_TRGSRC)
#define FLEXIO_TIMCTL_TRIGGER_TIMER(n) (FLEXIO_TIMCTL_TRGSEL((n) * 4 + 3) | FLEXIO_TIMCTL_TRGSRC)
#define FLEXIO_TIMCTL_TRIGGER_PIN(n) (FLEXIO_TIMCTL_TRGSEL((n) * 2) | FLEXIO_TIMCTL_TRGSRC)
...
#define FLEXSPI_LUT_INSTRUCTION(opcode, pads, operand) ((uint32_t)((((opcode) & 0x3F) << 10) | (((pads) & 0x03) << 8) | ((operand) & 0xFF)))
// 30.7.8: page 1637
