...
__attribute__((used, aligned(1024), section(".vectorsram"))) void (*_VectorsRam[NVIC_NUM_INTERRUPTS + 16])(void);
...
__attribute__((section(".startup"), naked, noreturn)) void ResetHandler(void)
{
...
__attribute__((section(".startup"), optimize("no-tree-loop-distribute-patterns"), noinline, noreturn)) static void ResetHandler2(void)
{
  __asm__ volatile("dsb" ::: "memory");
#if 1
  ...
  unsigned int i;
  for (i = 1; i < NVIC_NUM_INTERRUPTS + 16; i++)
...
FLASHMEM static void configure_external_ram()
{
  ...
  CCM_CBCMR = (CCM_CBCMR & ~(CCM_CBCMR_FLEXSPI2_PODF_MASK | CCM_CBCMR_FLEXSPI2_CLK_SEL_MASK)) | CCM_CBCMR_FLEXSPI2_PODF(5) | CCM_CBCMR_FLEXSPI2_CLK_SEL(3); // 88 MHz
...
__attribute__((section(".startup"), naked, weak)) void unused_interrupt_vector(void)
{
...
__attribute__((section(".flashmem"), weak)) int _read(int file __attribute__((unused)), char *ptr __attribute__((unused)), int len __attribute__((unused)))
{
  return 0;
}

__attribute__((section(".flashmem"), weak)) int _close(int fd __attribute__((unused)))
{
  return -1;
}
...
__attribute__((section(".flashmem"), weak)) int _fstat(int fd __attribute__((unused)), struct stat *st)
{
  st->st_mode = S_IFCHR;
  return 0;
}

__attribute__((section(".flashmem"), weak)) int _isatty(int fd __attribute__((unused)))
{
  return 1;
}

__attribute__((section(".flashmem"), weak)) int _lseek(int fd __attribute__((unused)), long long offset __attribute__((unused)), int whence __attribute__((unused)))
{
  return -1;
}

__attribute__((section(".flashmem"), weak)) void _exit(int status __attribute__((unused)))
{
  while (1)
    asm("WFI");
}

__attribute__((section(".flashmem"), weak)) void __cxa_pure_virtual()
{
  while (1)
    asm("WFI");
}

__attribute__((weak)) int __cxa_guard_acquire(int32_t *g)
{
  return !(*g);
}

__attribute__((weak)) void __cxa_guard_release(int32_t *g)
{
  *g = 1;
}

__attribute__((section(".flashmem"), weak)) void abort(void)
{
  while (1)
    asm("WFI");
}

__attribute__((section(".startup"), weak)) void _init()
{
}
